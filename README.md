...
```
go get -u github.com/Furiady/heimdall/v7
```
...
```go
import "github.com/Furiady/heimdall/v7/httpclient"
```
...
```go
import "github.com/Furiady/heimdall/v7/hystrix"
```
...
```go
// import "github.com/Furiady/heimdall/v7/plugins"
...
Further documentation can be found on [pkg.go.dev](https://pkg.go.dev/github.com/Furiady/heimdall/v7)
